...
namespace _15._04ado
{
    public partial class FormChangeUser : Form
    {
        ...
        public FormChangeUser(Form1 form, DataTable dTable, int num)
        {
            ...
            textBoxLogin.Text = dTable.Rows[num][1].ToString();
        ...
        {
            if (textBoxLogin.Text == "" || textBoxAdress.Text == "" || textBoxPassword.Text == "" ||
                textBoxPhone.Text == "")
            {
            ...
            {
                if (dataTable.Rows[number_Rows][1].ToString() == textBoxLogin.Text)
                {
                    break;
                }
                if (dataTable.Rows[i][1].ToString().Equals(textBoxLogin.Text))
                {
            ...
            dataTable.Rows[number_Rows][1] = textBoxLogin.Text.ToString();
